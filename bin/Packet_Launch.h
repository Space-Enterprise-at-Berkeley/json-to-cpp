...
{    
    ...
    {            
        ...
        return Launch(this->m_SystemMode, this->m_BurnTime, this->m_NitrousEnable, this->m_IpaEnable);    
    }    
...
private:
    ...
    Launch(float SystemModeIn, uint8_t BurnTimeIn, float NitrousEnableIn, float IpaEnableIn)
        : m_SystemMode(SystemModeIn), m_BurnTime(BurnTimeIn), m_NitrousEnable(NitrousEnableIn), m_IpaEnable(IpaEnableIn)
    {}
};
